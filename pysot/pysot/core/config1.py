...
__C.DATASET.NAMES = ('VID', 'COCO', 'DET', 'YOUTUBEBB', 'DRONE')
...
__C.DATASET.DRONE = CN()
__C.DATASET.DRONE.ROOT = 'training_dataset/drone/crop511'
__C.DATASET.DRONE.ANNO = 'training_dataset/drone/train.json'
__C.DATASET.DRONE.FRAME_RANGE = 1
__C.DATASET.DRONE.NUM_USE = -1
